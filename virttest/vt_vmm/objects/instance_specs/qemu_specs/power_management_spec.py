...
class QemuSpecPowerManagement(QemuSpec):
    def __init__(self, name, vt_params, node):
        super(QemuSpecPowerManagement, self).__init__(name, vt_params, node)
        self._parse_params()
    ...
    def _parse_params(self):
        self._spec.update({"power_management": self._define_spec()})

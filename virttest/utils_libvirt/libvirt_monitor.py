...
def check_domjobinfo_output(vm_name,
                            expected_domjobinfo={},
    ...
    if (expected_domjobinfo and "src_items" in expected_domjobinfo) or expected_domjobinfo_complete:
    ...
    if (expected_domjobinfo and "dest_items" in expected_domjobinfo) or expected_domjobinfo_complete:

...
class _LogicalImageManager(object):
    ...
    def define_logical_image_config(self, image_name, params):
        ...
        :param image_name: The image tag name, defined by the param "images"
    ...
    def clone_logical_image(self, image_id):
        """
        Clone the logical image.
        The cloned image has the same topology, the storage is cloned from the
        same storage pool too.
    ...
    def query_logical_image(self, image_name, vm_name=None):
        ...
        """
        LOG.debug(
            f"Get the logical image object id: name={image_name}, owner={vm_name}"
        )

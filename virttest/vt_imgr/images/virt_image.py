...
class _VirtImage(ABC):
    """
    The lower-level image, which has a storage resource(volume), is
    ...
    @classmethod
    def define_config(cls, image_name, image_params, node_tags):
        """
        ...
        """
        return cls._define_config_legacy(image_name, image_params, node_tags)

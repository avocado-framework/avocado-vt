...
class LogicalImage(ABC):
    ...
    def __init__(self, image_config):
        ...
        self._layer_images = dict()
        self._node_affinity = list()
        self._handlers = {
            "create": self.create,
    ...
    def node_affinity(self):
        ...
        Note the node names are defined in cluster.json
        """
        return self._node_affinity

    @node_affinity.setter
    def node_affinity(self, layer_images_access_node_names):
        self._node_affinity = layer_images_access_node_names

    def _get_layer_images_access_node_names(self):
        nodes = set()
    ...
    def set_node_affinity(self, node_names=None):
        ...
        self.node_affinity = self._get_layer_images_access_node_names()

...
class _QemuVirtImage(_VirtImage):
    ...
    def create_object(self):
        ...
        """
        LOG.debug("Created the qemu image object for %s", self.image_meta["name"])
    ...
    def clone(self):
        LOG.debug(f"Clone the image {self.image_name}")
        ...
        cloned_image_name = f"{config['meta']['name']}_clone_{postfix}"
    ...
    def backup(self, arguments):
        ...
        # Use the local dir pool to store the backup on node
        pool_id = None

...
class _VirtImage(ABC):
    """
    The upper-level image, in the context of a VM, is mapping to a VM's disk.
    It could be composed of one or more lower-level images, e.g. A qemu virt
    image could have a lower-level image chain:
      base ---> sn

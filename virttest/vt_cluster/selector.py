...
class _PoolSelector(object):
    ...
    pool_selectors_p1 += {"key": "nodes", "operator": "contains", values": "node1"},
    pool_selectors_p2 = [{"key": "type", "operator": "==", "values": "filesystem"},
    pool_selectors_p2 += {"key": "nodes", "operator": "contains", values": "node2"},
    """
    ...
    def _convert(self, pool_selector):
        ...
        values = pool_selector.get("values").split()
        if "nodes" == key:

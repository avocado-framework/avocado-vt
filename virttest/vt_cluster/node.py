...
class Node(object):
    ...
    def _upload_files(self, remote_path, target_path):
        """
        Upload files from a remote path on this node to a local target path on the controller.
        ...
        :param target_path: The destination path on the controller node.
    ...
    def upload_logs(self, target_path):
        """
        Upload all relevant agent and service logs from this node to the controller.

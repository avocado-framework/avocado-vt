...
class DevContainer(object):
    ...
    def pr_manager_object_define_by_params(self, pr_manager_name, pr_manager_params):
        ...
        if pr_manager_user_config:
            sock_path = pr_manager_params.get("pr_manager_user_sock_path")
            ...
            sock_path = os.path.join(
                data_dir.get_tmp_dir(), f"pr_mgr_{self.vmname}_{pr_manager_name}.sock"
            )

            pidfile = os.path.join(
                data_dir.get_data_dir(), f"pr_mgr_{self.vmname}_{pr_manager_name}.pid"
            )

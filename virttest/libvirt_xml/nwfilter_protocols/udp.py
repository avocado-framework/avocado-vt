...
class Udp(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="file", virsh_instance=base.base.virsh):
        ...
        super(Udp, self).__init__(
            protocol_tag="udp", type_name=type_name, virsh_instance=virsh_instance
        )
    ...
    class Attr(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "srcipto", self, parent_xpath="/", tag_name="udp", attribute="srcipto"
            )
            accessors.XMLAttribute(
                "dstipfrom",
                self,
            ...
            accessors.XMLAttribute(
                "dstipto", self, parent_xpath="/", tag_name="udp", attribute="dstipto"
            )
            accessors.XMLAttribute(
                "srcportstart",
                self,
            ...
            accessors.XMLAttribute(
                "dscp", self, parent_xpath="/", tag_name="udp", attribute="dscp"
            )
            accessors.XMLAttribute(
                "comment", self, parent_xpath="/", tag_name="udp", attribute="comment"
            )
            accessors.XMLAttribute(
                "state", self, parent_xpath="/", tag_name="udp", attribute="state"
            )
            accessors.XMLAttribute(
                "ipset", self, parent_xpath="/", tag_name="udp", attribute="ipset"
            )
            accessors.XMLAttribute(
                "ipsetflags",
                self,

...
class Stp(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="file", virsh_instance=base.base.virsh):
        ...
        super(Stp, self).__init__(
            protocol_tag="stp", type_name=type_name, virsh_instance=virsh_instance
        )
    ...
    class Attr(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "type", self, parent_xpath="/", tag_name="stp", attribute="type"
            )
            accessors.XMLAttribute(
                "flags", self, parent_xpath="/", tag_name="stp", attribute="flags"
            )
            accessors.XMLAttribute(
                "root_priority",
                self,
            ...
            accessors.XMLAttribute(
                "port", self, parent_xpath="/", tag_name="stp", attribute="port"
            )
            accessors.XMLAttribute(
                "port_hi", self, parent_xpath="/", tag_name="stp", attribute="port_hi"
            )
            accessors.XMLAttribute(
                "msg_age", self, parent_xpath="/", tag_name="stp", attribute="msg-age"
            )
            accessors.XMLAttribute(
                "msg_age_hi",
                self,
                parent_xpath="/",
                tag_name="stp",
                attribute="msg-age-hi",
            )
            accessors.XMLAttribute(
                "max-age", self, parent_xpath="/", tag_name="stp", attribute="max-age"
            )
            accessors.XMLAttribute(
                "max-age-hi",
                self,
            ...
            accessors.XMLAttribute(
                ...
                parent_xpath="/",
                tag_name="stp",
                attribute="forward-delay-hi",
            )
            accessors.XMLAttribute(
                "comment", self, parent_xpath="/", tag_name="stp", attribute="comment"
            )

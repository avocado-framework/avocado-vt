...
class Vlan(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="file", virsh_instance=base.base.virsh):
        ...
        super(Vlan, self).__init__(
            protocol_tag="vlan", type_name=type_name, virsh_instance=virsh_instance
        )
    ...
    def get_attr(self):
        ...
        vlan_attr = dict(list(node.items()))
    ...
    class Attr(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "vlanid", self, parent_xpath="/", tag_name="vlan", attribute="vlanid"
            )
            accessors.XMLAttribute(
                "encap_protocol",
                self,
                parent_xpath="/",
                tag_name="vlan",
                attribute="encap-protocol",
            )
            accessors.XMLAttribute(
                "comment", self, parent_xpath="/", tag_name="vlan", attribute="comment"
            )

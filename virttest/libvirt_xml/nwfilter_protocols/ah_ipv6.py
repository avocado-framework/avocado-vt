"""
ah-ipv6 protocol support class(es)
...
class Ah_ipv6(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="file", virsh_instance=base.base.virsh):
        ...
        super(Ah_ipv6, self).__init__(
            protocol_tag="ah-ipv6", type_name=type_name, virsh_instance=virsh_instance
        )
    ...
    class Attr(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "dscp", self, parent_xpath="/", tag_name="ah-ipv6", attribute="dscp"
            )
            accessors.XMLAttribute(
                "comment",
                self,
            ...
            accessors.XMLAttribute(
                "state", self, parent_xpath="/", tag_name="ah-ipv6", attribute="state"
            )
            accessors.XMLAttribute(
                "ipset", self, parent_xpath="/", tag_name="ah-ipv6", attribute="ipset"
            )
            accessors.XMLAttribute(
                "ipsetflags",
                self,

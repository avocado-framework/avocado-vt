"""
ipv4 protocol support class(es)
...
class Ip(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="file", virsh_instance=base.base.virsh):
        ...
        super(Ip, self).__init__(
            protocol_tag="ip", type_name=type_name, virsh_instance=virsh_instance
        )
    ...
    class Attr(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "dscp", self, parent_xpath="/", tag_name="ip", attribute="dscp"
            )
            accessors.XMLAttribute(
                "comment", self, parent_xpath="/", tag_name="ip", attribute="comment"
            )

...
https://libvirt.org/formatdomain.html#device-leases
"""
...
class Lease(base.UntypedDeviceBase):
    ...
    def __init__(self, virsh_instance=base.base.virsh):
        ...
        accessors.XMLElementText(
            "lockspace", self, parent_xpath="/", tag_name="lockspace"
        )
        ...
        super(Lease, self).__init__(device_tag="lease", virsh_instance=virsh_instance)

...
class Rng(base.UntypedDeviceBase):
    ...
    def __init__(self, virsh_instance=base.base.virsh):
        accessors.XMLAttribute(
            "rng_model", self, parent_xpath="/", tag_name="rng", attribute="model"
        )
        accessors.XMLElementDict("rate", self, parent_xpath="/", tag_name="rate")
    ...
    class Backend(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLElementText(
                "backend_dev", self, parent_xpath="/", tag_name="backend"
            )
            ...
            accessors.XMLAttribute(
                property_name="backend_protocol",
                libvirtxml=self,
                forbidden=None,
                parent_xpath="/",
                tag_name="protocol",

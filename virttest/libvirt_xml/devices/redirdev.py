...
class Redirdev(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="redirdev", virsh_instance=base.base.virsh):
        super(Redirdev, self).__init__(
            device_tag="redirdev", type_name=type_name, virsh_instance=virsh_instance
        )
        accessors.XMLAttribute(
            "type", self, parent_xpath="/", tag_name="redirdev", attribute="type"
        )
        accessors.XMLAttribute(
            "bus", self, parent_xpath="/", tag_name="redirdev", attribute="bus"
        )
        ...
        accessors.XMLElementDict(
            "protocol", self, parent_xpath="/", tag_name="protocol"
        )
        accessors.XMLElementDict("boot", self, parent_xpath="/", tag_name="boot")
    ...
    class Source(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            accessors.XMLAttribute(
                "mode", self, parent_xpath="/", tag_name="source", attribute="mode"
            )
            accessors.XMLAttribute(
                "host", self, parent_xpath="/", tag_name="source", attribute="host"
            )
            accessors.XMLAttribute(
                "service",
                self,
            ...
            accessors.XMLAttribute(
                "tls", self, parent_xpath="/", tag_name="source", attribute="tls"
            )
            accessors.XMLAttribute(
                "path", self, parent_xpath="/", tag_name="source", attribute="path"
            )

...
class Hostdev(base.TypedDeviceBase):
    ...
    class Source(base.base.LibvirtXMLBase):
        ...
        __slots__ = ('untyped_address', 'vendor_id', 'product_id', 'adapter_name')
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLElementNest('untyped_address', self, parent_xpath='/',
                                     ...
                                     subclass_dargs={
                                         'virsh_instance': virsh_instance})
            accessors.XMLAttribute('adapter_name', self, parent_xpath='/', tag_name='adapter', attribute='name')
        ...
        class UntypedAddress(base.UntypedDeviceBase):
            __slots__ = ('device', 'domain', 'bus', 'slot', 'function', 'target', 'unit')

...
class Hostdev(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="hostdev", virsh_instance=base.base.virsh):
        accessors.XMLAttribute(
            "type", self, parent_xpath="/", tag_name="hostdev", attribute="type"
        )
        accessors.XMLAttribute(
            "mode", self, parent_xpath="/", tag_name="hostdev", attribute="mode"
        )
        accessors.XMLAttribute(
            "model", self, parent_xpath="/", tag_name="hostdev", attribute="model"
        )
        accessors.XMLAttribute(
            "managed", self, parent_xpath="/", tag_name="hostdev", attribute="managed"
        )
        accessors.XMLAttribute(
            "sgio", self, parent_xpath="/", tag_name="hostdev", attribute="sgio"
        )
        accessors.XMLAttribute(
            "rawio", self, parent_xpath="/", tag_name="hostdev", attribute="rawio"
        )
        ...
        accessors.XMLAttribute(
            "boot_order", self, parent_xpath="/", tag_name="boot", attribute="order"
        )
        accessors.XMLElementBool(
            "readonly", self, parent_xpath="/", tag_name="readonly"
        )
        accessors.XMLElementBool(
            "shareable", self, parent_xpath="/", tag_name="shareable"
        )
    ...
    class Source(base.base.LibvirtXMLBase):
        ...
        def __init__(self, virsh_instance=base.base.virsh):
            ...
            accessors.XMLAttribute(
                "host_name", self, parent_xpath="/", tag_name="host", attribute="name"
            )
            accessors.XMLAttribute(
                "host_port", self, parent_xpath="/", tag_name="host", attribute="port"
            )
            accessors.XMLAttribute(
                "address_bus",
                self,
        ...
        class UntypedAddress(base.UntypedDeviceBase):
            ...
            def __init__(self, virsh_instance=base.base.virsh):
                ...
                accessors.XMLAttribute(
                    "unit", self, parent_xpath="/", tag_name="address", attribute="unit"
                )
                accessors.XMLAttribute(
                    "uuid", self, parent_xpath="/", tag_name="address", attribute="uuid"
                )
                super(self.__class__, self).__init__(
        ...
        class Initiator(base.base.LibvirtXMLBase):
            ...
            def __init__(self, virsh_instance=base.base.virsh, auth_user=""):
                accessors.XMLAttribute(
                    "iqn_id", self, parent_xpath="/", tag_name="iqn", attribute="name"
                )
                super(self.__class__, self).__init__(virsh_instance=virsh_instance)
                self.xml = "<initiator/>"

...
class Smartcard(base.TypedDeviceBase):
    ...
    def __init__(self, type_name="spicevmc", virsh_instance=base.base.virsh):
        ...
        accessors.XMLAttribute(
            "source_mode", self, parent_xpath="/", tag_name="source", attribute="mode"
        )
        accessors.XMLAttribute(
            "source_host", self, parent_xpath="/", tag_name="source", attribute="host"
        )
        accessors.XMLAttribute(
            "source_service",
            self,
        ...
        accessors.XMLAttribute(
            "address_type", self, parent_xpath="/", tag_name="address", attribute="type"
        )
        accessors.XMLAttribute(
            "address_controller",
            self,
        ...
        accessors.XMLAttribute(
            "address_slot", self, parent_xpath="/", tag_name="address", attribute="slot"
        )
        super(Smartcard, self).__init__(
            device_tag="smartcard", type_name=type_name, virsh_instance=virsh_instance
        )

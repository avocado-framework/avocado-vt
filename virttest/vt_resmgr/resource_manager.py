...
class _VTResourceManager(object):
    ...
    def _define_resource_config(self, resource_name, resource_type, resource_params):
        ...
        LOG.debug(f"Define the resource configuration of {resource_name} by pool {pool.name}")
    ...
    def create_resource_from_params(self, resource_name, resource_type, resource_params):
        """
        ...
        :rtype: string
        """
        resource_config = self._define_resource_config(resource_name, resource_type, resource_params)
    ...
    def create_resource_from_source(self, source_resource_id, target_pool_id=None):
        ...
        LOG.debug(f"Create a resource object from resource {source_resource.name} in pool {target_pool.name}")

...
class _ResourcePool(ABC):
    ...
    def define_resource_config(self, resource_name, resource_type, resource_params):
        ...
        # FIXME: if vm_node is None, nodes = n1 n2, storage_type = filesystem
    ...
    def create_resource_object_from(self, resource):
        new_resource = resource.create_object_from_self()
        new_resource.resource_pool = self.pool_id
        self.resources[new_resource.resource_id] = new_resource
        return new_resource.resource_id
    ...
    def clone_resource(self, resource_id):
        ...
        # Set the same pool and bindings as the source resource
    ...
    def update_resource(self, resource_id, config):
        ...
        node_names = arguments.pop("nodes", None)
        if node_names:

...
logging.basicConfig(filename='/tmp/avocado_utils_process_%s.log' % timestamp, filemode='w',
...
def run_stdout_text(cmd, timeout=None, verbose=True, ignore_status=False,
                    allow_output_check=None, shell=False,
                    env=None, sudo=False, ignore_bg_processes=False,
                    encoding=None):
    out = run(cmd, timeout, verbose, ignore_status, allow_output_check, shell,
              env, sudo, ignore_bg_processes, encoding).stdout_text
    return out


def run_stderr_text(cmd, timeout=None, verbose=True, ignore_status=False,
                    allow_output_check=None, shell=False,
                    env=None, sudo=False, ignore_bg_processes=False,
                    encoding=None):
    out = run(cmd, timeout, verbose, ignore_status, allow_output_check, shell,
              env, sudo, ignore_bg_processes, encoding).stderr_text
    return out

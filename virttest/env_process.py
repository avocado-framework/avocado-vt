...
def preprocess_image(test, params, image_name, vm_process_status=None, vm_name=None):
    ...
    if params.get_boolean("multihost"):
        ...
        if vm_name:
            imgr.update_virt_image(image_id, {"config": {"owner": vm_name}})
    ...
    if params.get("force_create_image") == "yes":
        ...
        if params.get_boolean("multihost"):
            volume = imgr.get_virt_image_info(
        ...
        if params.get_boolean("multihost"):
            imgr.get_virt_image_info(image_id)
...
def postprocess_image(test, params, image_name, vm_process_status=None, vm_name=None):
    ...
    image_id = None
    if params.get_boolean("multihost"):
        image_id = imgr.query_virt_image(image_name, vm_name)
        if image_id is None:

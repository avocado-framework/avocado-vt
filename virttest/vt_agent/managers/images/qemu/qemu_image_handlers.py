...
def _dd(virtual_image_config, source_image_name, target_image_name, bs=None, count=None, skip=None, rawcopy=False):
    """
    ...
    virtual_image_meta = virtual_image_config["meta"]
    virtual_image_spec = virtual_image_config["spec"]
    source_image_config = virtual_image_spec["images"][source_image_name]
    target_image_config = virtual_image_spec["images"][target_image_name]
...
def _backup(virtual_image_config, arguments):
    ...
    for image_name in image_names:
        ...
        if volume_config["meta"]["volume-type"] != "file":
            # FIXME: need a data copy utils

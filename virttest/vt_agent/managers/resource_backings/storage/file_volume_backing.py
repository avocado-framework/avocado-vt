...
from .volume_backing import _VolumeBacking

LOG = logging.getLogger("avocado.service." + __name__)


class _FileVolumeBacking(_VolumeBacking):
    ...
    def sync_resource_info(self, pool_connection, arguments=None):
        allocation, allocated = None, self.is_allocated()
        if allocated:
            s = os.stat(self._uri)
    ...
    def clone_resource(self, pool_connection, source_backing, arguments=None):
        if not source_backing.is_allocated():

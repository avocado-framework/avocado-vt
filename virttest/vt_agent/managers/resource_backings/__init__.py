...
from .storage import (DirVolumeBacking, DirPoolConnection,
                      NfsVolumeBacking, NfsPoolConnection,)
...
_backing_classes = {
    DirPoolConnection.POOL_TYPE: {
        DirVolumeBacking.RESOURCE_TYPE: DirVolumeBacking,
    },

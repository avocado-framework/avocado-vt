...
from .nfs_backing import _get_backing_class
from .nfs_pool_connection import _NfsPoolConnection


class _NfsBackingManager(_ResourceBackingManager):
    ...
    def create_pool_connection(self, pool_config, pool_access_config):
        pool_conn = _NfsPoolConnection(pool_config, pool_access_config)
        pool_conn.startup()

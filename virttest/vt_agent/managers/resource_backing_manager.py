...
class ResourceBackingManager(object):
    ...
    def startup(self):
        """
        Start the resource backing manager in startup of the resmgr on master
        """
        # In case we don't do the cleanup work successfully after a job
        self.teardown()

    def teardown(self):
        """
        Stop the resource backing manager in teardown of the resmgr on master
        """

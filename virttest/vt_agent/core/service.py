...
from .data_dir import get_managers_module_dir, get_services_module_dir
...
def load_services():
    ...
    # FIXME: Import the managers module first individually since the following
    #  services modules depends.
    ...
    services_dir = get_services_module_dir()

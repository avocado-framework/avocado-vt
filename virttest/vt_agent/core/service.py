...
def load_services():
    ...
    # import the managers module firstly since we need its instances from __init__
    module_name = "managers"
    managers_module = importlib.import_module("vt_agent.managers")
    sys.modules[module_name] = managers_module

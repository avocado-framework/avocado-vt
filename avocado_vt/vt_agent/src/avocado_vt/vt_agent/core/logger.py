...
def init_logger(console_level=None, file_level=None, log_format=None):
    ...
    Sets up a logger named "avocado.agent" with both console and file output.
    ...
    # Set the logger level to the most verbose of console and file levels
    ...
    try:
        ...
        logger.info("Log file: %s", data_dir.AGENT_LOG_FILENAME)

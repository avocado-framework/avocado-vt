...
from avocado_vt.vt_agent.core.logger import LOG_FORMAT
...
def cleanup_tmp_files(file_path):
    ...
    This function can remove a single file, a directory tree, or files
    matching a glob pattern.

    :param file_path: A path to a file, directory, or a glob pattern
                      of items to remove.
    :type file_path: str
    """
    try:

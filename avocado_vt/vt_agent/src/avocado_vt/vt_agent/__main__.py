...
from avocado_vt.vt_agent.app.args import init_arguments
from avocado_vt.vt_agent.app.cmd import run
from avocado_vt.vt_agent.core import data_dir as core_data_dir
from avocado_vt.vt_agent.core.logger import init_logger
...
def setup_directories(dirs, logger):
    ...
    """
    logger.info("Setting up agent directories...")
...
def main():
    """Main entry point for the vt_agent."""
    args = init_arguments()
    ...
    init_logger()
    logger = logging.getLogger("avocado.agent.__main__")
    logger.info("Starting Avocado VT Agent...")

    setup_directories(dirs, logger)

    logger.info("Agent initialization complete. Starting server...")

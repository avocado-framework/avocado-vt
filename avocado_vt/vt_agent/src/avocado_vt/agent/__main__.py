...
from avocado_vt.agent.core.logger import init_logger
...
def main():
    ...
    ip_sniffer_log_dir = core_data_dir.get_ip_sniffer_log_dir()

    dirs = (data_dir, log_dir, download_dir, console_log_dir, daemon_log_dir, ip_sniffer_log_dir)

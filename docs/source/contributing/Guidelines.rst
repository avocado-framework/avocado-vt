...
3. (Optional) Run hooks on all files to check current state::
...
1. [Must] Coding style should conform to what's enforced by black (run ``pre-commit run --all-files black``)

...
2. [Must] PR commit message is meaningful. Refer to `this link <https://autotest.readthedocs.io/en/latest/main/developer/SubmissionChecklist.html>`_ on how to write a good commit message
